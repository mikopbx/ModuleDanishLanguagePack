...
namespace Modules\ModuleDanishLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Danish Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Danish UI translations from Messages/da/ directory
 * - Danish voice prompts from Sounds/da-dk/ directory
 *
 ...
 *
 * @package Modules\ModuleDanishLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleDanishLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Danish packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Danish Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Danish Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Danish Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Danish Language Pack uninstalled successfully',
            LOG_INFO
        );
