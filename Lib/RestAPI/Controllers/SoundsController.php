...
namespace Modules\ModuleDanishLanguagePack\Lib\RestAPI\Controllers;
 ...
 *   GET /pbxcore/api/v3/module-danish-language-pack/sounds
 *   GET /pbxcore/api/v3/module-danish-language-pack/sounds/progress
 */
class SoundsController extends ModulesControllerBase
{
    private const string MODULE_UNIQUE_ID = 'ModuleDanishLanguagePack';
