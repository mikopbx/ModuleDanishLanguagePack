...
namespace Modules\ModuleDanishLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleDanishLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * DanishLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class DanishLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-danish-language-pack';
