...
namespace Modules\ModuleDanishLanguagePack\App\Controllers;

use MikoPBX\AdminCabinet\Controllers\BaseController;
use MikoPBX\Modules\PbxExtensionUtils;

/**
 * ModuleDanishLanguagePackController
 *
 * Controller for Danish Language Pack module information page
 */
class ModuleDanishLanguagePackController extends BaseController
{
    private string $moduleUniqueID = 'ModuleDanishLanguagePack';
    ...
    public function indexAction(): void
    {
        ...
        // Count sound files
        $soundsDir = $this->moduleDir . '/Sounds/da-dk';
        $soundFileCount = 0;
        if (is_dir($soundsDir)) {
        ...
        $messagesDir = $this->moduleDir . '/Messages/da';
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-danish-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-danish-language-pack-progress.js", true);
    ...
    public function soundsAction(): void
    {
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-danish-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-danish-language-pack-sounds-index.js", true);
