...
<div class="ui segment">
    <a class="ui basic compact button"
       href="{{ url('module-danish-language-pack/module-danish-language-pack/index') }}">
        <i class="left arrow icon"></i>{{ t._('mlp_da_BackToOverview') }}
    </a>
    ...
    <div id="languagepack-sounds-table-container" style="margin-top: 1em;">
        <table class="ui selectable compact unstackable table" id="languagepack-sounds-table">
            <thead>
                <tr>
                    <th>{{ t._('mlp_da_ColumnFile') }}</th>
                    <th class="cdr-player-column">{{ t._('mlp_da_ColumnPlayer') }}</th>
                    <th>{{ t._('mlp_da_ColumnConverted') }}</th>
                    <th></th>
                </tr>
            </thead>
            <tbody></tbody>
